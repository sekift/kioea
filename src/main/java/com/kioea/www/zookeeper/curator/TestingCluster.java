...
public class TestingCluster implements Closeable {
	 ...
	 * 
	 * @param specs
	 *            map of an instance spec to its set of quorum instances. Allows
	 *            simulation of an ensemble with instances having different
	 *            config peers
	 */
	...
	public Collection<InstanceSpec> getInstances() {
		Iterable<InstanceSpec> transformed = Iterables.transform(servers,
