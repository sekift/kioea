...
// */
//
//package com.sekift.zookeeper.curator;
//
...
//		 * register JMX beans. Something in the shutdown of a QuorumPeer causes
//		 * the state of the MBeanRegistry to get confused and generates an
//		 * assert Exception.
//		 */
//		ClassPool pool = ClassPool.getDefault();
//		try {
//			pool.appendClassPath(new javassist.LoaderClassPath(TestingCluster.class.getClassLoader())); // re:
