...
class ServerHelper {
	private static class ServerCnxnFactoryMethods {
		...
		private ServerCnxnFactoryMethods(Constructor<?> constructor, Method configureMethod, Method startupMethod,
	...
	static {
		...
		try {
			if (serverCnxnFactoryClass != null) {
				localServerCnxnFactoryMethods = new ServerCnxnFactoryMethods(serverCnxnFactoryClass.getConstructor(),
				...
				localNioServerCnxn = new NioServerCnxnMethods(nioServerCnxnFactoryClass
						.getConstructor(InetSocketAddress.class), nioServerCnxnFactoryClass.getDeclaredMethod(
						"startup", ZooKeeperServer.class), nioServerCnxnFactoryClass.getDeclaredMethod("shutdown"));
			}
		} catch (Exception e) {
			e.printStackTrace();
			throw new Error(e);
